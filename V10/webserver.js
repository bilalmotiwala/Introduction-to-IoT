		...
		for(i=0; i<4; i++)
		{
			...
			if(newvalue != check[i])
			{
				if(newvalue == 1)
				{
					...
					if(i == 0)
					{
						socket.emit('TCTBUTTON[0]', constone);
					}
					else if(i == 1)
					{
						socket.emit('TCTBUTTON[1]', constone);
					}
					else if(i == 2)
					{
						socket.emit('TCTBUTTON[2]', constone);
					}
					else
					{
						socket.emit('TCTBUTTON[3]', constone);
					}					
				...
				else
				{
					...
					socket.emit('TCTBUTTON[0]', constzero);
					check[i] = newvalue;
					...
					{
						socket.emit('TCTBUTTON[1]', constzero);
					}
					else if(i == 2)
					{
						socket.emit('TCTBUTTON[2]', constzero);
					}
					else
					{
						socket.emit('TCTBUTTON[3]', constzero);
					}
				}
			}
		}
